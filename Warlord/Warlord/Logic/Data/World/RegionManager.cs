...
namespace Warlord.Logic.Data.World
{
    class RegionUpdater : WorldBase
    {
        ...
        public void Initalize()
        {
            ...
            GlobalApplication.Application.GameEventManager.Subscribe( Update, "actor_moved" );
        }
        ...
        private void CreateRegion(Vector2i regionCoordiantes)
        {
            ...
            GlobalApplication.Application.GameEventManager.SendEvent(new GameEvent(new Optional<object>(this), "region_added", newRegion, 0));
        ...
        private void UnloadRegion(Vector2i regionCoordiantes)
        {
            ...
            { 
                GlobalApplication.Application.GameEventManager.SendEvent(new GameEvent(new GameTools.Optional<object>(this), "region_added", deadRegion, 0));
